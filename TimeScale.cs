...
namespace HallOfGodsAI.Utils
{
    public class TimeScale:MonoBehaviour
    {
         public void Awake()
        {
            TimeScaleManager.TimeScaleActive = true;
            Time.timeScale = TimeScaleManager.CurrentTimeScale;
         ...
         public void OnDestroy()
        {
            ...
            Time.timeScale = 1;
            TimeScaleManager.CurrentTimeScale = 1f;
         ...
         private void ScaleFreeze(ILContext il)
         {
            ...
            //  cursor.EmitDelegate<Func<float>>(() => TimeScaleManager.CurrentTimeScale);
         ...
         private IEnumerator QuitToMenu_Start(On.QuitToMenu.orig_Start orig, QuitToMenu self)
         {
             ...
             TimeController.GenericTimeScale = TimeScaleManager.CurrentTimeScale;
         }
         ...
         private void GameManager_SetTimeScale_1(On.GameManager.orig_SetTimeScale_float orig, GameManager self, float newTimeScale)
         {
             ...
             TimeController.GenericTimeScale = (newTimeScale <= 0.01f ? 0f : newTimeScale) * TimeScaleManager.CurrentTimeScale;
         }
    }
